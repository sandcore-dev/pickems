...
@section('title', __('Edit season') . ' - ' . __('Admin') . ' -')
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route( 'admin.seasons.update', [ 'season' => $season->id ] ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
						...
						@component('admin.form.submit')
							@slot('cancel', route( 'admin.seasons.index', [ 'season' => $season->series->id ] ))
