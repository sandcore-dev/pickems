...
@section('title', __('Edit race') . ' - ' . __('Admin') . ' -')
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route( 'admin.races.update', [ 'race' => $race->id ] ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
						...
						@component('admin.form.submit')
							@slot('cancel', route( 'admin.races.index', [ 'race' => $race->season->id ] ))
